...
rose.load(function (err, mesh, material) {
  ...
  if (SHOULD_USE_CUBE_MAP) cubeCamera.updateCubeMap(renderer.renderer, scene);
});

// main material
var material = materials.shell;

if (SHOULD_USE_CUBE_MAP) {
...
module.exports.render = function () {
  ...
  if (count % 5 === 0 && SHOULD_USE_CUBE_MAP) {
